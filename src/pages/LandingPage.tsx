    ...
    return (
        <div className="flex flex-col h-full">
            <div className="flex-1 bg-beige">
                <div id = "BeigeContainer" className = "bg-beige h-screen flex items-center justify-center" style={{backgroundImage: `url('./backgroundbig.jpg')`, backgroundSize: '100% 60%', backgroundRepeat: 'no-repeat', backgroundPosition: 'center'}}>
